    ...
    >
      <defs>
        <linearGradient id="akSky" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="100%" stopColor="#e8fbf8" />
        </linearGradient>
        <linearGradient id="akBar" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#dde6ff" />
          <stop offset="55%" stopColor="#ece7ff" />
          <stop offset="100%" stopColor="#d7f5f2" />
        </linearGradient>
      ...
      <g className="fx-float">
        <path
          ...
          strokeWidth={6}
        />
        <rect x="206" y="42" width="60" height="70" rx="10" fill="#ffe3e4" stroke={INK} strokeWidth={5} />
      ...
      <g>
        ...
        <rect x="232" y="176" width="764" height="282" rx="24" fill="#fbfcff" stroke={INK} strokeWidth={5} />
        ...
        <g transform="translate(524 186)">
          <rect x="0" y="6" width="54" height="62" rx="10" fill="#ffe3e4" stroke={INK} strokeWidth={4} />
          ...
          <rect x="120" y="6" width="54" height="62" rx="10" fill="#dde6ff" stroke={INK} strokeWidth={4} />
          <text x="147" y="46" textAnchor="middle" fontSize={15} fontWeight={800} fill={BRAND} fontFamily="Inter, sans-serif">
            DOCX
          </text>
          <rect x="188" y="6" width="54" height="62" rx="10" fill="#d7f5f2" stroke={INK} strokeWidth={4} />
        ...
        <g transform="translate(862 190)">
          ...
          <circle cx="114" cy="28" r="18" fill="#ffe3e4" stroke={INK} strokeWidth={4} />
      ...
      <g transform="rotate(-2.5)">
        ...
        <path
          ...
          strokeWidth={7}
        />
        <path d="M350 558 l-52 52 v-34 a18 18 0 0 1 18 -18 Z" fill="#ffe3e4" stroke={INK} strokeWidth={6} />
        <rect x="96" y="298" width="254" height="76" rx="18" fill="#ffe3e4" stroke={INK} strokeWidth={6} />
        ...
        <DocLines x={120} y={398} width={206} rows={6} gap={27} color="#ffd3d5" delay={0.1} height={12} />
        </g>
      </g>
      ...
      {/* ---------------- output documents ---------------- */}
      <OutputDoc x={702} y={292} label="DOCX" badge="W" accent={BRAND} tint="#dde6ff" delay={0.1} />
      <OutputDoc x={870} y={292} label="TXT" badge="T" accent={TEAL} tint="#d7f5f2" delay={0.45} />
      <OutputDoc x={1038} y={292} w={150} label="PDF" badge="A" accent={VIOLET} tint="#ece7ff" delay={0.8} />
      ...
      <g>
        ...
        {/* body */}
        <path d="M478 640 q0 -66 74 -66 q74 0 74 66 Z" fill="#dde6ff" stroke={INK} strokeWidth={6} />
        ...
        <path d="M414 604 a16 16 0 1 0 0 24 h24 a12 12 0 0 0 0 -24 Z" fill="#dde6ff" stroke={INK} strokeWidth={5} />
        {/* head */}
        ...
        {/* glasses */}
        <circle cx="530" cy="544" r="23" fill="#eef3ff" stroke={INK} strokeWidth={5} />
        <circle cx="580" cy="544" r="23" fill="#eef3ff" stroke={INK} strokeWidth={5} />
        ...
        <circle cx="508" cy="570" r="7" fill="#ffd3d5" />
        <circle cx="598" cy="570" r="7" fill="#ffd3d5" />
        {/* desk */}
      ...
      <g>
        <path
          ...
          strokeWidth={6}
        />
        <DocLines x={128} y={630} width={158} rows={6} gap={24} color="#cddafc" delay={0.2} />
      </g>
      <g className="fx-lens">
        <circle cx="258" cy="736" r="44" fill="#eef3ff" fillOpacity="0.7" stroke={INK} strokeWidth={7} />
      ...
      {/* ---------------- gear cluster + status ---------------- */}
      <g>
        <circle className="fx-pop" cx="820" cy="640" r="36" fill="#d7f5f2" stroke={INK} strokeWidth={6} />
        <path className="fx-pop" d="M802 640 l12 14 l24 -28" fill="none" stroke={TEAL} strokeWidth={7} />
        <Gear cx={906} cy={732} r={58} teeth={12} fill="#dde6ff" spin="fx-spin" duration="9s" />
        <Gear cx={1010} cy={668} r={46} teeth={10} fill="#ece7ff" spin="fx-spin-rev" duration="7s" />
        <Gear cx={1006} cy={776} r={34} teeth={9} fill="#fff0d6" spin="fx-spin" duration="5s" />
        <Gear cx={1096} cy={740} r={26} teeth={8} fill="#d7f5f2" spin="fx-spin-rev" duration="4s" />
