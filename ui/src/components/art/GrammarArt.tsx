  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <Line x={200} y={286} w={520} color="#cddafc" delay={0} />
        <rect className="fx-glow" x={736} y={280} width={120} height={24} rx={8} fill="#ffe3e4" stroke={ROSE} strokeWidth={3} />
        <Line x={200} y={334} w={300} color="#cddafc" delay={0.2} />
        <rect className="fx-glow" x={520} y={328} width={148} height={24} rx={8} fill="#fff0d6" stroke={AMBER} strokeWidth={3} style={{ animationDelay: "0.5s" }} />
        <Line x={688} y={334} w={168} color="#cddafc" delay={0.4} />
        <Line x={200} y={382} w={656} color="#cddafc" delay={0.6} />
        <Line x={200} y={430} w={430} color="#cddafc" delay={0.8} />
        <rect className="fx-glow" x={648} y={424} width={128} height={24} rx={8} fill="#d7f5f2" stroke={TEAL} strokeWidth={3} style={{ animationDelay: "1s" }} />
        ...
        {/* status strip */}
        <rect x="200" y="492" width="656" height="70" rx="20" fill="#f7f9ff" stroke={INK} strokeWidth={5} />
      ...
      <g className="fx-float">
        ...
        <rect x="798" y="650" width="120" height="34" rx="17" fill="#ffe3e4" stroke={INK} strokeWidth={4} />
        ...
        <rect x="994" y="650" width="110" height="34" rx="17" fill="#d7f5f2" stroke={INK} strokeWidth={4} />
        <text x="1049" y="674" textAnchor="middle" fontSize={20} fontWeight={800} fill={TEAL} fontFamily="Inter, sans-serif">
          fixed
        </text>
        <Line x={798} y={708} w={240} color="#cddafc" delay={0.3} />
        <Line x={798} y={736} w={160} color="#e4e9f5" delay={0.5} />
      </g>

      {/* AI core */}
      <g className="fx-float-sm">
        <circle cx="180" cy="680" r="74" fill="#ece7ff" stroke={INK} strokeWidth={7} />
      ...
      {/* score badge */}
      <g className="fx-pop">
        <circle cx="990" cy="196" r="70" fill="#d7f5f2" stroke={INK} strokeWidth={7} />
