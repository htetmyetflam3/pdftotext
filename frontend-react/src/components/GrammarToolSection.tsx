...
export const GrammarToolSection: React.FC<GrammarToolSectionProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <ToolShell
      ...
      status={issueCount ? `${issueCount} issue${issueCount > 1 ? 's' : ''} found` : 'No issues found'}
      eyebrow="02 / spell & grammar"
      title="Burmese Spell & Grammar AI Workspace"
      subtitle="Drag and drop your document directly below to inspect grammatical structure and tone marks"
      badges={["Myanmar Orthography Standard (မြန်မာစာအဖွဲ့)"]}
